  ...
  return (
    <div className="flex h-screen bg-gray-950 overflow-hidden">
      ...
      <aside
        ...
        style={{ background: "linear-gradient(180deg, light-dark(#ffffff, #0f1117) 0%, light-dark(#f9fafb, #0d1117) 100%)" }}>
        ...
        <div className="border-t border-gray-800/60 px-2 pt-2 pb-3 space-y-1">
          <label className="flex items-center justify-between gap-2 px-3 py-2 text-xs text-gray-400">
            ...
            <select
              ...
              defaultValue={document.documentElement.style.colorScheme || "light dark"}
              onChange={e => {
